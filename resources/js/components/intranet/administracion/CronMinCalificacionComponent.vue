            ...
            <div class="col-sm-12">
                <div class="card">
                    <header class="card-header">
                        Sincronización de nota minima de CV de Calificación de Docentes
...
export default {
    ...
    methods: {
        sincronizar: function() {
            axios.get("sincronizar-minCalificacion/").then(response => {
                // console.log(response);
            });
            this.disabledButton = true;
        },
        control: function() {
            axios.get("control-minCalificacion/").then(response => {
