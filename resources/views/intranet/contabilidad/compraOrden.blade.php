...
<body>
    ...
    <table style="font-size:8px;" border="0">
        ...
        @if($composeElement['prev_total'] > 0)
        <tr style="font-size: 7px;">
            <td colspan="30" style="text-align:right; font-weight:bold;"></td>
            <td colspan="2" style="text-align:left; font-weight:bold;">Vienen <br></td>
            <td colspan="3" style="text-align:right; font-weight:bold;">{{number_format($composeElement['prev_total'], 2)}}</td>
        </tr>
        @endif
        <?php
        foreach ($composeElement['items'] as $index => $item) {
            $item['monto'] = floatval($item['codigo']) * $item['medida']; ?>
            <tr style="text-align:center">
                <td colspan="4" style="font-weight:bold;">{{$item["unidades"]}}</td>
                <td colspan="4" style="font-weight:bold;">{{$item["precio_unitario"]}}</td>
                ...
                <td colspan="5" style="text-align:right; font-weight:bold;"> {{ number_format($item['precio_subtotal'], 2) }}</td>
            </tr>
        <?php } ?>
        @if($composeElement['total'] < $total) <tr style="font-size: 7px;">
            <td colspan="30" style="text-align:right; font-weight:bold;"></td>
            <td colspan="2" style="text-align:left; font-weight:bold;">Van... <br></td>
            <td colspan="3" style="text-align:right; font-weight:bold;">{{ number_format($composeElement['total'],2) }}</td>
            </tr>
            @endif
